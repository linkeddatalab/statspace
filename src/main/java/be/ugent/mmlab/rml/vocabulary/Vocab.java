...
public class Vocab {
    ...
    public static String RMLX_NAMESPACE = "http://pebbie.org/ns/rmlx#";
    ...
    public enum QLTerm {
        ...
        CSV_CLASS("CSV"),
        XLS_CLASS("Spreadsheet"),
    	XLS2_CLASS("Spreadsheet2"),
    	NULL_CLASS("Null Processor");
    ...
    public enum RMLXTerm {
        ...
        private RMLXTerm(String displayName) {
            this.displayName = displayName;
        }
